...
# R script to simulate demand for price increase by 10% to all sites (2018 survey data) 
# 
...
#Import data
#-----------------------------------------------------------------#
load("r-output/2017-sp-estimates") #SP
...
# Split df_sim to each individual -> df_sim_1:1285
...
#Export
#############################################################################################
save(summary_draw, file = "r-output/2017-sp-z1-demand") #SP