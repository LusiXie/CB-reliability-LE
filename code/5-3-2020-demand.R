...
# R script to simulate demand for price increase by 10% to all sites (2020 survey data) 
# 
...
# Output:
#       1. r-output/2019-z1-demand: full simulation results
###################################################################
...
for (i in 1:n) {
  ...
  df_sim_split[[i]][[2]][["price_p_list"]][[1]][2:80] <- df_sim_split[[i]][[1]][["price"]][[1]][2:80]*0.1
}
...
#Export
#############################################################################################
save(summary_draw, file = "r-output/2019-sp-z1-demand") #SP
